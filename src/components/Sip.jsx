...
const HERO_STATS = [
  { label: "Minimum SIP", value: "Rs. 500 / month", note: "Start lean and scale as you grow." },
  { label: "Suggested step-up", value: "10% yearly", note: "Nudge contributions alongside income." },
  { label: "Goal horizons", value: "1 - 20 years", note: "Match plans across short and long term needs." }
];

const FEATURE_CARDS = [
  { icon: Target, title: "Goal-linked roadmaps", description: "Align each SIP with education, retirement, or wealth goals and monitor progress in real time." },
  { icon: ShieldCheck, title: "Risk-matched baskets", description: "Select curated mutual fund combinations based on your risk profile and timeline." },
  { icon: SlidersHorizontal, title: "Flexible contributions", description: "Pause, top-up, or increase your SIP whenever your cashflow changes - no paperwork needed." },
  { icon: PiggyBank, title: "Automated discipline", description: "Auto-debits keep your plan on track so compounding keeps working even when life gets busy." }
];

const JOURNEY_STEPS = [
  { title: "Choose your destination", description: "Define the target corpus and timeline for every goal to determine the monthly contribution." },
  { title: "Pick the right mix", description: "We shortlist SIP baskets aligned to your risk appetite and recommend a smart step-up schedule." },
  { title: "Track and optimise", description: "Review performance, adjust contributions, and rebalance effortlessly as life goals evolve." }
];

const SUPPORT_CARDS = [
  { icon: Sparkles, title: "Dedicated advisors", description: "Schedule 1:1 goal planning and periodic portfolio reviews with our advisory desk." },
  { icon: CalendarCheck, title: "Onboarding support", description: "Get guided assistance for KYC, bank mandates, and setting up or pausing SIP debits." },
  { icon: BookOpen, title: "Learning hub", description: "Understand SIP strategies, taxation, and best practices through curated explainers." }
];
...
export default function Sip({ calculatorsOnly = false }) {
...
const buildStepupUrl = () => {
  ...
  const handleHeroScroll = (event, sectionId) => {
  ...
  return (
    <div id="sip" className="sip-page bg-white">
      <section id="sip-overview" className="sip-hero-section text-light py-5" >
        <div className="container"  style={{paddingTop:"70px"}}>
          <div className="row align-items-center g-4">
            <div className="col-lg-7">
              <span className="badge bg-white text-primary fw-semibold mb-3">
                Systematic Investment Plans
              </span>
              <h1 className="display-6 fw-bold mb-3">
                Start smart, stay consistent, and let compounding work for you
              </h1>
              <p className="lead text-white-50 mb-4">
                Build goal-based mutual fund portfolios that auto-invest every month,
                adapt with your income, and keep you on course for the milestones that matter.
              </p>
              <div className="d-flex flex-wrap gap-3">
                ...
                <a
                  ...
                  href="/calculator"
                  onClick={(e) => { e.preventDefault(); try { navigate('/calculator'); } catch { window.location.href = '/calculator'; } }}
                >
            ...
            <div className="col-lg-5">
              <div className="card border-0 bg-white bg-opacity-10 shadow-sm h-100">
                <div className="card-body p-4">
                  <h2 className="h5 fw-semibold text-white mb-3">
                    What to expect from Growth Avenues SIPs
                  </h2>
                  <ul className="list-unstyled mb-0">
                    {FEATURE_CARDS.slice(0, 3).map((feature) => (
                      <li
                        key={feature.title}
                        className="d-flex gap-3 align-items-start py-2 border-bottom border-white border-opacity-25"
                      >
                        <feature.icon size={22} className="text-warning flex-shrink-0" />
                        <div>
                          <div className="fw-semibold text-white">{feature.title}</div>
            ...
            {HERO_STATS.map((stat) => (
              <div className="col-md-4" key={stat.label}>
                <div className="stat-tile h-100">
                  <span className="text-uppercase small text-white-50">{stat.label}</span>
                  <div className="fs-4 fw-semibold text-white mt-1">{stat.value}</div>
                  <p className="mb-0 text-white-50 small">{stat.note}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="sip-benefits" className="py-5">
        <div className="container">
          <div className="row justify-content-center text-center mb-4">
            <div className="col-lg-8">
              <h2 className="fw-bold">Benefits of building your SIP with us</h2>
              <p className="text-secondary mb-0">
                Goal-linked journeys, curated fund baskets, and active monitoring that help you stay invested for the long term.
              </p>
            </div>
          </div>
      ...
      <section id="sip-journey" className="py-5 bg-light">
        <div className="container">
          <div className="row justify-content-center text-center mb-4">
            <div className="col-lg-8">
              <h2 className="fw-bold">Your SIP journey in three steps</h2>
              <p className="text-secondary mb-0">
                We simplify everything from defining the goal to monitoring growth and rebalancing when goals change.
              </p>
            </div>
          </div>
          <div className="row g-4">
              ...
              <div className="col-md-4" key={step.title}>
                <div className="card h-100 border-0 shadow-sm">
                  <div className="card-body">
                    ...
                    <h3 className="h6 fw-semibold mt-3">{step.title}</h3>
      ...
      <section id="sip-support" className="py-5">
        <div className="container">
          <div className="row justify-content-center text-center mb-4">
            <div className="col-lg-8">
              <h2 className="fw-bold">Support built around your goals</h2>
              <p className="text-secondary mb-0">
                From onboarding to optimisation, we combine digital tools with human expertise so you are never on your own.
              </p>
            </div>
          </div>
          <div className="row g-4">
            {SUPPORT_CARDS.map((item) => (
              <div className="col-md-4" key={item.title}>
                <div className="card sip-support-card h-100 border-0 shadow-sm">
                  <div className="card-body">
                    <div className="icon-pill mb-3">
      ...
      {calculatorsOnly && (
        <section id="calculators">
          <div className="container">
            <div className="row justify-content-center text-center mb-4">
              <div className="col-lg-8">
                <h2 className="fw-bold mb-2" style={{marginTop:"50px"}}>Calculators</h2>
      ...
      <style>{`
        .sip-hero-section {
          background: linear-gradient(135deg, #023b63 0%, #0b84c9 100%);
        }
        ...
        .step-badge {
          ...
          height: 40px;
          border-radius: 999px;
          background: linear-gradient(135deg, #0b84c9 0%, #15a0e1 100%);
          color: #fff;
          font-weight: 600;
        }
        .sip-support-card {
        ...
        .sip-support-card:hover {
          ...
          box-shadow: 0 0.75rem 1.5rem rgba(15, 122, 191, 0.15);
        }
